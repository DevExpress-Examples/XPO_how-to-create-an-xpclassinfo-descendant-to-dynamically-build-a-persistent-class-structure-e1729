...
Namespace DynamicDataTable
    ...
    Public Class DynamicDataTableClassInfo
        ...
        Public Sub New(ByVal dictionary As XPDictionary, ByVal table As DataTable)
            ...
            If table.PrimaryKey.Length <> 1 Then Throw New NotSupportedException()
            ...
            For Each column As DataColumn In table.Columns
                ...
                If table.PrimaryKey(0) Is column Then member.AddAttribute(New KeyAttribute(column.AutoIncrement))
            Next
        ...
        Public Overrides Sub ClearModifications(ByVal theObject As Object)
            Call PersistentBase.GetModificationsStore(theObject).ClearModifications()
        End Sub
